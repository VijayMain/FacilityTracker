...
%> 
			<table style="width: 98%;" class="gridtable">
					...
					<tr>
					<td colspan="9" style="font-weight: bold;background-color: yellow;font-size: large;">Please select Storage Location...!!!</td>
					</tr>
					<%-- <%
					PreparedStatement	ps_check = con.prepareStatement("SELECT  * FROM stocktaking_summary where enable=1 and Plant='"
											+ comp + "' and fiscal_year='" +fiscal +"'  order by stocktype_desc desc");
