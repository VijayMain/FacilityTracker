...
<!--main content start-->
    ...
    %>
        <jsp:include page="SixSigma_Header.jsp" > 
  		<jsp:param name="define" value="<%=improve %>"/>
		</jsp:include> 
            <!-- <h3 class="page-header"><i class="fa fa-laptop"></i> Dashboard</h3> -->
         <!-- <ol class="breadcrumb"> 
            <li><i class="icon_menu-square_alt2" style="color: gray;"></i>Project Definition and Charter</li>
             <li><i class="icon_pencil" style="color: gray;"></i><a href="SixSigma_NewProject.jsp" style="font-weight: bold;">Create New</a> </li>
             <li><i class="icon_like" style="color: gray;"></i><a href="SixSigma_NewApp.jsp" style="font-weight: bold;">Approvals</a></li>
...
<div style="height:500px;overflow: scroll;"> 
			<table class="gridtable" width="100%"> 
				...
				/* 	defineQuery = "select * from tran_pt_problem where phase_id=5 and enable=1 and project_lead=" +uid+
							" union select * from tran_pt_problem where phase_id=5 and id in "+
					...
					while(rs_data.next()){
						defineQuery = "select * from tran_pt_problem where enable=1 and phase_id=5 order by changed_date desc";
					}
					
					
					ps_data = con_master.prepareStatement("select * from tran_pt_problem where phase_id=5 and enable=1 and project_lead=" +uid);
					rs_data = ps_data.executeQuery();
					while(rs_data.next()){
						defineQuery = "select * from tran_pt_problem where enable=1 and phase_id=5 and project_lead=" +uid +" order by changed_date desc";
					}
...
<a href="SixSigma_Improve_Data.jsp?problem_id=<%=rs_check.getInt("id")%>" style="color: black;" title="Update Data"><img alt="#" src="img/update.png" style="height: 20px;"> </a>
