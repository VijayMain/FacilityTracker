    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row"> 
            ...
            <ol class="breadcrumb">
              <li><i class="icon_error-circle_alt"></i>Rejected Master Data</li> 
              <li><i class="icon_refresh" style="color: gray;"></i><a href="Master_Reject.jsp" style="font-weight: bold;">Refresh</a>  </li>
        <%
...
<div class="row" style="height:500px;">
	...
	<%
		...
		ps_check = con_master.prepareStatement("SELECT plant  FROM rel_SAPmaster_releaseStrategy where enable=1 and u_id="+uid);
     	...
     	if(rs_check.next()){
		query = "SELECT * FROM tran_SAPmaster_create where (plant in(SELECT plant  FROM rel_SAPmaster_releaseStrategy where enable=1 and user_type='pur' and u_id="+uid+") or created_by="+uid+") and stage_no=4 order by id desc";
     	}else{
     		query = "SELECT * FROM tran_SAPmaster_create where enable=1 and created_by="+uid+" and stage_no=4 order by id desc";
     	}
		
		if(dept_id==18){
     		query = "SELECT * FROM tran_SAPmaster_create where enable=1 and stage_no=4 order by id desc";
     	}
	...
	<tr style="cursor:default; font-size: 12px;">
		...
		<td>
		<a href="Master_Approval_Log.jsp?id=<%=rs_check.getInt("id")%>&home=2">
