...
<table class="gridtable" width="100%">
  <tr>
    ...
    <td align="center" style="font-size: 12px;font-weight: bold;background-color: #a59eff">RESULT PHASE</td>
      	<%
  		if(request.getParameter("success")!=null){
		%>
		<td align="center" style="font-size: 12px;font-weight: bold;background-color: #06a415;color: white;">
		<a href="SixSigma_Result_Data.jsp?problem_id=<%=problem_id%>" style="color: white;"><%=request.getParameter("success") %></a>
		</td>
        <%
		...
		<a href="SixSigma_Result_Data.jsp?problem_id=<%=problem_id%>"  style="color: white;"><%=request.getParameter("statusNop") %></a>
		</td>  
	    <%
		}
		%>
...
while(rs_sql.next()){
	...
	String control_days ="" ,improve_days="";
	int control_lbl =0;
	
	ps_sql = con_master.prepareStatement("select * from rel_pt_phase where enable=1 and seqNo between 2 and 7");
	rs_sql = ps_sql.executeQuery();
	while(rs_sql.next()){
...
<%
ps_data2 = con_master.prepareStatement("select * from rel_pt_resultPhase where enable=1 and problem_id="+problem_id);
rs_data2 = ps_data2.executeQuery();
if(rs_data2.next()){
%>
<table class="gridtable" width="100%">
...
<input type="hidden" name="controlDate" id="controlDate" value="<%=controlDate%>">
<table class="gridtable" width="100%">
 <tr>
    <th colspan="6" style="font-size: 12px;font-weight: bold;background-color: #a59eff">Results</th>
  </tr>
  <tr>
    <th>Base line Rejection ppm</th>
    <th>Targetted Rejection ppm</th>
  ...
  <tr>
    ...
    <td><input type="submit" class="btn-primary" name="submit" id="submitMeasure" value="SAVE" style="font-size:12px; font-weight: bold;height: 24px !important;"></td>
  </tr>
</table>
</form>
<%
