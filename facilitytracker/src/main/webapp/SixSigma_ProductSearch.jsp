...
<% 
PreparedStatement ps_check = con.prepareStatement("SELECT TOP 1000 id,material,material_description  FROM rel_SAPmaster_mm60 where plant='"+plant+"' and enable=1 and material_type in('HALB','FERT') and material_description like '%"+matSearch+"%'");
