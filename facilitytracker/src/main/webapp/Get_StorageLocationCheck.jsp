...
%>
 <span id="importdata">
    ...
    <%
   ps_check = con.prepareStatement("select * from stocktaking_storageLocation where enable=1 and plant='"+plant+"' and storage_location in(SELECT storage_loc  FROM stocktaking_attachments where plant='"+plant+"'  and enable=1 and fiscal_year='"+fiscal+"' and stocktype_desc='"+stock_typeDescr+"')");
