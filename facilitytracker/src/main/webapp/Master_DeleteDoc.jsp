...
try{
	...
	PreparedStatement ps_wfhTaskDelete =con.prepareStatement("update tran_SAPmaster_create set filename=null,attachment=null,changed_by="+Integer.valueOf(session.getAttribute("uid").toString())+",changed_date ='"+timeStamp+"' where id="+id);
