...
function GetStorageLocation(val) {
	...
	var xmlhttp;
		...
		xmlhttp.open("POST", "Get_StorageLocation.jsp?plant=" + val + "&fiscal="+fiscal_year+ "&stock_type="+stock_type, true);
		xmlhttp.send();
};
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_upload"></i>File Upload
              <%
...
<!-- ************************************ Tiles to Display**************************************************************** -->
	<div class="row">
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading"><span  style="color: black;"> Add New Request</span></header>
              <div class="panel-body">
                <div class="form"> 
            <form action="Stock_Taking_Control" method="post" enctype="multipart/form-data" id="feedback_form" class="form-validate form-horizontal">
                    ...
                    <div class="col-lg-10">
                     <input type="file" id="file_doc" name="file_doc" required>
                    </div>
                    </div>
                    <div class="form-group">
