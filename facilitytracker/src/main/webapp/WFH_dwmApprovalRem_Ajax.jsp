...
try{ 
	...
	int id = Integer.valueOf(request.getParameter("id")); 
  	...
  	int up=0;
	PreparedStatement ps_check = con.prepareStatement("update tran_dwm_tasks set approval_remark=? where id =" +id);
	ps_check.setString(1, appr_remark);
	up = ps_check.executeUpdate();
	
%>
<span id="remark_ajax<%=id %>" style="color: black;font-weight: bold;">
<%
if(up>0){
	PreparedStatement ps_user = con.prepareStatement("select * from  tran_dwm_tasks where id =" +id);
