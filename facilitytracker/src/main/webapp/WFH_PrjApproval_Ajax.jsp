...
try{ 
	...
	// *******************************************************************************************************************************************************************
	String approval = "";
	PreparedStatement ps_check = con.prepareStatement("update tran_wfh_project_task set approval_id=?,approved_by=?,approved_date=?,changed_by=?,changed_date=? where id =" +id);
...
%>
<span id="approval_Prjbtn<%=id %>" style="color: black;font-weight: bold;">
<%
if(up>0){
%>
