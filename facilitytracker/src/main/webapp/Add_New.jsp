        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_pencil"></i>Add New</li>
            </ol>
          </div>
        </div> 
<!-- ********************************************************************************************************************* -->
<!-- ************************************ Tiles to Display**************************************************************** -->
	<div class="row">
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">Add New Request</header>
            ...
            <form action="FM_New_RequestControl" method="post" enctype="multipart/form-data" id="feedback_form" class="form-validate form-horizontal">
                    ...
                    <div class="col-lg-10"> 
                      ...
                      <%
                      ps_check = con.prepareStatement("SELECT * FROM user_tbl_company where enable=1");
                    ...
                    <div class="form-group">
                    <label class="control-label col-lg-2" for="inputSuccess"><strong>Facility Required for</strong><b style="color: red;"> * </b></label>
                    <div class="col-lg-10"> 
                      <select name="facility_for" id="facility_for" class="form-control m-bot15" style="font-weight: bold;color: black;" required>
                      <option value=""> - - - - Select - - - -  </option>
                      <%
                    ...
                    <div class="form-group ">
                      <label for="ccomment" class="control-label col-lg-2"><strong>Issue Statement</strong><b style="color: red;"> * </b></label>
                      <div class="col-lg-10">
                        <input class="form-control" style="font-weight: bold;color: black;font-size: 18px;" id="issue" name="issue" minlength="5" type="text" required />
                      </div>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label col-lg-2" for="inputSuccess"><strong>Priority</strong><b style="color: red;"> * </b></label>
                    <div class="col-lg-10"> 
                      <select name="priority" id="priority" class="form-control m-bot15" style="font-weight: bold;color: black;" required>
                      <option value=""> - - - - Select - - - -  </option>
                      <%
                    ...
                    <div class="form-group">
                    <label class="control-label col-lg-2" for="inputSuccess"><strong>Responsible Dept.</strong><b style="color: red;"> * </b></label>
                    <div class="col-lg-10"> 
                      <select name="resp_dept" id="resp_dept" class="form-control m-bot15" style="font-weight: bold;color: black;" required>
                      <option value=""> - - - - Select - - - -  </option>
                      <%
                    ...
                    <div class="form-group">
                    <label class="control-label col-lg-2" for="inputSuccess"><strong>Evidence Image only</strong></label>
                    <div class="col-lg-10">
