...
<div style="height:500px;overflow: scroll;"> 
			<table class="gridtable" width="100%"> 
					...
					while(rs_data.next()){
						defineQuery = "select * from tran_pt_problem where enable=1 and phase_id=2 order by changed_date desc";
					}
					
					
					ps_data = con_master.prepareStatement("select * from tran_pt_problem where phase_id=2 and enable=1 and project_lead=" +uid);
					rs_data = ps_data.executeQuery();
					while(rs_data.next()){
						defineQuery = "select * from tran_pt_problem where enable=1 and phase_id=2 and project_lead=" +uid +" order by changed_date desc";
					}
...
<a href="SixSigma_Define_Charter.jsp?problem_id=<%=rs_check.getInt("id")%>" style="color: black;" title="Update Data"><img alt="#" src="img/update.png" style="height: 20px;"> </a>
